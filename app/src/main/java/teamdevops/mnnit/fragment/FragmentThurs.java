 ...
 */
public class FragmentThurs extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rvThursday);
    ...
    public void populateRecyclerView() {
        ...
        ArrayList<TimeTableData> dataSet = db.getTimeTableData(TimeTableActivity.DAY[3]);
