 ...
 */
public class FragmentSat extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rvSaturday);
    ...
    public void populateRecyclerView() {
        ...
        ArrayList<TimeTableData> dataSet = db.getTimeTableData(TimeTableActivity.DAY[5]);
